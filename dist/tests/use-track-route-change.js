...
describe('useTrackRouteChange (next/navigation)', () => {
    ...
    beforeEach(() => {
        ...
        Object.defineProperty(window, 'location', {
            configurable: true,
            value: Object.assign(Object.assign({}, originalLocation), { href: 'http://localhost/initial-path', pathname: '/initial-path', origin: 'http://localhost' }),
        });
    ...
    it('handles initial route and subsequent changes', () => {
        ...
        Object.defineProperty(window, 'location', {
            configurable: true,
            value: Object.assign(Object.assign({}, originalLocation), { href: 'http://localhost/new-path', pathname: '/new-path', origin: 'http://localhost' }),
        });
    ...
    it('does not track if tagID is null', () => {
        Object.defineProperty(window, 'location', {
            configurable: true,
            value: Object.assign(Object.assign({}, originalLocation), { href: 'http://localhost/some-path', pathname: '/some-path', origin: 'http://localhost' }),
        });
